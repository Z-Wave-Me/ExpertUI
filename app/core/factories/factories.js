...
appFactory.factory('dataService', function($http, $q, $interval, $filter, $location, $window, myCache, cfg) {
    ...
    function zmeCapabilities(data) {
        var capabilities = [0x8E, 0x21, 0x53, 0xB7, 0x1C, 0xDC, 0x1B, 0x88, 0x06, 0xF5, 0x21, 0x48, 0x3F, 0x96, 0xB8, 0x0E, 0x7B, 0xCD, 0x1E, 0x6F, 0x96, 0xCF, 0xE8, 0xCA, 0x8A, 0x2A, 0x9A, 0xF8, 0xBD, 0x44, 0x52, 0xD6, 0xAB, 0x53, 0x86, 0x75, 0xE9, 0xCA, 0x02, 0x38, 0x60, 0x16, 0x05, 0x95, 0x4F, 0x82, 0x70, 0xE3]; 
        ///JS/Run/zway.ZMECapabilities([0x8E, 0x21, 0x53, 0xB7, 0x1C, 0xDC, 0x1B, 0x88, 0x06, 0xF5, 0x21, 0x48, 0x3F, 0x96, 0xB8, 0x0E, 0x7B, 0xCD, 0x1E, 0x6F, 0x96, 0xCF, 0xE8, 0xCA, 0x8A, 0x2A, 0x9A, 0xF8, 0xBD, 0x44, 0x52, 0xD6, 0xAB, 0x53, 0x86, 0x75, 0xE9, 0xCA, 0x02, 0x38, 0x60, 0x16, 0x05, 0x95, 0x4F, 0x82, 0x70, 0xE3])
        return $http({
            method: 'POST',
            url: cfg.server_url + cfg.runjs_url + 'zway.ZMECapabilities(' + capabilities + ')'
             //data: $.param(data),
//              headers: {
//                "Content-Type": "application/x-www-form-urlencoded"
//            }
