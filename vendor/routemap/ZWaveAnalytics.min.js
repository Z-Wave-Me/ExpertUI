...
this.N.forEach(function(a){a.frameType&&b.g.G(a.nodeId.value,b.i,"Explore Frame"===a.frameType.value)});this.N.forEach(function(a){a.delivered&&a.hops&&(b.g.J(b.i,a.nodeId.value,a.hops.value,a.tries.value-1),b.b.O(b.i,a.nodeId.value,a.hops.value,a.returnRSSI.value,1),0!=a.lastFailPath.value[0]&&b.b.A(a.lastFailPath.value[0],a.lastFailPath.value[1]))})};e.prototype.Y=function(){var b=this;for(a in this.a.devices){var a=parseInt(a,10);if(1!=this.a.devices[a].data.basicType.value){var c=a===this.i?"Controller":
!1===this.a.devices[a].data.isListening.value?!0===this.a.devices[a].data.sensor250.value||!0===this.a.devices[a].data.sensor1000.value?"FLiRS":"Sleeping":"Routing";this.F.push({id:a,usage:this.g.T(a),type:c,x:null,y:null,name:this.a.devices[a].data.givenName.value,dead:this.a.devices[a].data.isFailed.value});c=this.a.devices[a].data.neighbours.value.slice();for(var d in this.a.devices)d=parseInt(d,10),-1===c.indexOf(d)&&(this.a.devices[d]&&-1!==this.a.devices[d].data.neighbours.value.indexOf(a)?
(console.log("Adding asymmetrical route "+a+" -> "+d+" to official neighbour list"),c.push(d)):this.a.devices[d]&&1!==this.a.devices[d].data.basicType.value&&(0<this.b.usage(a,d)||0<this.b.usage(d,a))&&this.a.devices[d]&&(console.log("Adding actual route "+a+" -> "+d+" to official neighbour list"),c.push(d)));c.forEach(function(c){if(a!=c){var d=b.links.filter(function(b){return b.source==c&&b.target==a})[0];d?Object.assign(d,{rssi21:b.b.H(a,c),usage21:b.b.usage(a,c),fails21:b.b.M(a,c)}):b.links.push({source:a,
target:c,rssi12:b.b.H(a,c),usage12:b.b.usage(a,c),fails12:b.b.M(a,c)})}})}}};e.prototype.Z=function(){var b=this;this.F.map(function(a){var c=b.W.filter(function(b){return b.id===a.id})[0];c&&(a.x=c.x,a.y=c.y)})};e.prototype.X=function(){for(b in this.a.devices){var b=parseInt(b,10);var a=[];var c=this.a.devices[b].instances,d;for(d in c){if(c[d].commandClasses[133])for(e in c[d].commandClasses[133].data){var e=parseInt(e,10);!isNaN(e)&&c[d].commandClasses[133].data[e].nodes.value&&c[d].commandClasses[133].data[e].nodes.value.forEach(function(b){a.push(b)})}if(c[d].commandClasses[142])for(e in c[d].commandClasses[142].data)if(e=
