window.ZWaveNetworkAnalyticsLib=function(){function t(b,a){return b.length===a.length&&b.every(function(c,d){return c===a[d]})}function p(b){return b.reduce(function(a,c){return a+c},0)}function v(b){return b.filter(function(a,c,d){return d.indexOf(a)===c})}function u(b){b.sort(function(a,c){return a-c})}function n(b,a){this.src=b;this.i=a;this.A=[];this.o=this.B=0}function k(){this.links=[]}function q(b,a){this.src=b;this.i=a;this.c=[];this.C=this.u=this.L=this.O=this.m=0}function r(b){this.w=0;
this.path=b.slice()}function l(){this.v=[]}function g(b,a,c){this.a=b;this.g=a;this.fa=c||[];this.j=this.a.controller.data.nodeId.value;this.J=[];this.links=[];this.b=new k;this.l=new l;this.P=[];this.la();this.ia();this.ja();this.ha();this.ma();this.ka()}n.prototype.use=function(b,a,c,d){this.B+=void 0!==d?d:1;c=127===c||void 0===c||-32<c&&125>c||-94>c?null:125===c?-94:126===c?-32:c;null!==c&&this.A.push(c)};n.prototype.D=function(){this.o++};n.prototype.usage=function(){return this.B};n.prototype.M=
function(){return this.A};k.prototype.use=function(b,a,c,d,e){this.f(b,a).use(b,a,c,e);this.f(a,b).use(b,a,d,0)};k.prototype.D=function(b,a){this.f(b,a).D()};k.prototype.N=function(b,a,c,d,e,f){var h=c.slice();h.unshift(b);b=c.slice();b.push(a);a=d?d.slice():void 0;c=e?e.slice():void 0;for(var m=0;m<h.length;m++)this.use(h[m],b[m],d?a[m]:void 0,e?c[m]:void 0,f)};k.prototype.f=function(b,a){var c=this.links.filter(function(d){return d.src==b&&d.i==a})[0];c||(c=new n(b,a),this.links.push(c));return c};
k.prototype.usage=function(b,a){var c=Math.max(0,Math.max.apply(null,this.links.map(function(e){return e.usage()}))),d=this.f(b,a).usage();return 0!==c?d/c:0};k.prototype.F=function(b,a){var c=this.f(b,a),d=c.usage();return 0!==d?c.o/d:0};k.prototype.M=function(b,a){var c;return(c=(c=this.f(b,a).A)?p(c)/c.length:void 0)?(c-0)/-100:0};q.prototype.send=function(b,a,c){var d=this.c.filter(function(e){return t(e.path,b)})[0];d||(d=new r(b),this.c.push(d));d.use();this.m++;this.L+=a;c&&this.O++};q.prototype.K=
function(b,a){var c=this.c.filter(function(d){return t(d.path,b)})[0];c||(c=new r(b),this.c.push(c));c.use();this.u++;this.C+=a?1:0};q.prototype.getStats=function(){var b=this.c.map(function(c){return c.path.length}),a=this.c.map(function(c){return c.path});return{minOutHops:Math.min.apply(null,b),maxOutHops:Math.max.apply(null,b),routes:a,retries:this.m?this.L/this.m:null,deliveryRate:this.m?this.O/this.m:null,sent:this.m,explores:this.u?this.C/this.u:null,received:this.u}};r.prototype.use=function(){this.w++};
l.prototype.s=function(b,a){var c=this.v.filter(function(d){return d.src==b&&d.i==a})[0];c||(c=new q(b,a),this.v.push(c));return c};l.prototype.send=function(b,a,c,d,e){this.s(b,a).send(c,d,e)};l.prototype.K=function(b,a,c,d){this.s(b,a).K(c,d)};l.prototype.ba=function(b,a){return this.s(b,a).c};l.prototype.I=function(b,a){return this.s(b,a).getStats()};l.prototype.H=function(b,a){var c=this.ba(b,a),d=new k;c.forEach(function(e){d.N(b,a,e.path,void 0,void 0,e.w)});return d};l.prototype.X=function(b){var a=
0,c=0;this.v.forEach(function(d){a+=p(d.c.map(function(e){return-1===e.path.indexOf(b)?0:e.w}));c+=p(d.c.map(function(e){return e.w}))});return c?a/c:0};l.prototype.G=function(b){var a=[];this.v.forEach(function(c){0<p(c.c.map(function(d){return-1===d.path.indexOf(b)?0:1}))&&a.push(c.i)});u(a);return a};g.prototype.la=function(){var b=this;this.g.forEach(function(a){if(a.frameType&&(b.l.K(a.nodeId,b.j,a.hops||[],"Explore Frame"===a.frameType),a.hops)){var c=Array(a.hops.length+1);c[a.hops.length]=
a.RSSI;b.b.N(a.nodeId,b.j,a.hops,void 0,c,1)}});this.T=!1;this.g.forEach(function(a){!a.frameType&&a.hops&&(b.T=!0,b.l.send(b.j,a.nodeId,a.hops,a.tries-1,a.delivered),b.b.N(b.j,a.nodeId,a.hops,a.returnRSSI,void 0,1),0!=a.lastFailPath[0]&&b.b.D(a.lastFailPath[0],a.lastFailPath[1]))})};g.prototype.ia=function(){var b=this;for(a in this.a.devices){var a=parseInt(a,10);if(1!==this.a.devices[a].data.basicType.value){var c=a===this.j?"Controller":!1===this.a.devices[a].data.isListening.value?!0===this.a.devices[a].data.sensor250.value||
...
c[d].commandClasses[133].data[e].nodes.value.forEach(function(h){a.push(h)});if(c[d].commandClasses[142])for(e in c[d].commandClasses[142].data)if(e=parseInt(e,10),!isNaN(e)&&c[d].commandClasses[142].data[e].nodesInstances.value){var f=0;c[d].commandClasses[142].data[e].nodesInstances.value.forEach(function(h){0===f++%2&&a.push(h)})}}u(a);this.P[b]=v(a)}};g.prototype.ma=function(){var b=[],a=this.g[0]&&this.g[0].updateTime||0,c=this.g[0]&&this.g[0].updateTime||0;for(d in this.a.devices){var d=parseInt(d,
10);1!==this.a.devices[d].data.basicType.value&&b.push(d)}this.g.forEach(function(e){if(e.delivered||e.dstNodeId){var f=b.indexOf(e.nodeId);-1!==f&&b.splice(f,1)}a<e.updateTime&&(a=e.updateTime);c>e.updateTime&&(c=e.updateTime)});this.ea=b;this.na=a;this.U=c;this.ga=this.g.length};g.prototype.ka=function(){var b={};for(a in this.a.devices){var a=parseInt(a,10);b[a]||(b[a]={});if(this.a.devices[a].data.h)for(var c in this.a.devices[a].data.h)if(c=parseInt(c,10),!isNaN(c)){var d=this.a.devices[a].data.h[c].value,
e=[];if(d){for(var f=0;4>f&&0!==d[f];f++)232<d[f]&&(e=null),e.push(d[f]);if(null===e)break;b[a][c]=e}}}this.h=b};g.prototype.W=function(b){return this.P[b]};g.prototype.Y=function(){return this.J};g.prototype.V=function(){return this.links};g.prototype.R=function(){return this.j};g.prototype.ca=function(b){return this.a.devices[b].data.isListening.value};g.prototype.G=function(b){var a=this,c=this.R();return this.l.G(b).filter(function(d){return 1!==a.a.devices[d].data.basicType.value&&d!=c})};g.prototype.H=
function(b,a){var c=this,d=this.l.H(b,a);d.links.forEach(function(e){e.o=c.b.f(e.src,e.i).o+c.b.f(e.i,e.src).o});return d};g.prototype.I=function(b,a){return this.l.I(b,a)};g.prototype.da=function(b,a,c){b=this.S(b)[a];if(!b||b.length!=c.length)return!1;for(a=0;a<b.length;a++)if(b[a]!==c[a])return!1;return!0};g.prototype.S=function(b){var a={},c;for(c in this.h[b])a[c]=this.h[b][c].slice();return a};g.prototype.Z=function(){var b={},a;for(a in this.h)for(var c in this.h[a])b[a]||(b[a]={}),b[a][c]=
this.h[a][c].slice();return b};g.prototype.aa=function(b,a,c){return b.usage(a,c)};g.prototype.$=function(b,a,c){return b.F(a,c)};g.prototype.getStats=function(){return{haveIMA:this.T,nodeNoStatistics:this.ea,startStatistics:this.na,endStatistics:this.U,packetsCount:this.ga}};return g}();window.ZWaveNetworkAnalyticsLib.prototype.getNodes=window.ZWaveNetworkAnalyticsLib.prototype.Y;window.ZWaveNetworkAnalyticsLib.prototype.getLinks=window.ZWaveNetworkAnalyticsLib.prototype.V;
